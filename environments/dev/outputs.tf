...
output "nat_mode" {
  ...
  description = "NAT mode in use (bastion-nat for dev)"
}
...
# NAT Gateway outputs (null in dev environment)
output "nat_gateway_id" {
  value       = module.terraform_ws.nat_gateway_id
  description = "ID of the NAT Gateway (null in dev - uses bastion NAT)"
}

output "nat_gateway_public_ip" {
  value       = module.terraform_ws.nat_gateway_public_ip
  description = "Public IP of the NAT Gateway (null in dev - uses bastion NAT)"
}
